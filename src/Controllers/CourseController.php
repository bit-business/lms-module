    ...
    public function view()
    {
        try {
            ...
            $courses = CourseUser::where('user_id', '=', $user->id)
                ->join('skijasi_courses', 'skijasi_courses.id', '=', 'skijasi_course_user.course_id')
                ->join('skijasi_users', 'skijasi_users.id', '=', 'skijasi_courses.created_by')
                ->select(
                    'skijasi_course_user.user_id',
                    'skijasi_course_user.course_id',
                    'skijasi_courses.name',
                    'skijasi_courses.subject',
                    'skijasi_courses.room',
                    'skijasi_courses.join_code',
                    'skijasi_users.name as created_by'
                )
                ->get()
                ->toArray();

...
use NadzorServera\Skijasi\Module\LMSModule\Helpers\CourseUserHelper;
    ...
    public function add(Request $request)
    {
        try {
            ...
            $request->validate([
                ...
                'topic_id' => 'nullable|integer|exists:NadzorServera\Skijasi\Module\LMSModule\Models\Topic,id',

...
namespace NadzorServera\Skijasi\Module\LMSModule\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;
use Symfony\Component\VarExporter\VarExporter;
use NadzorServera\Skijasi\Module\LMSModule\Facades\LMSModule;
...
class LMSModuleSetup extends Command
{
     ...
     * @var string
     */
    protected $name = 'skijasi-lms-module:setup';
     ...
     * @var string
     */
    protected $description = 'Setup Skijasi Modules For LMS';
    ...
    {
        Artisan::call('vendor:publish', ['--tag' => 'SkijasiLMSModule']);

        $this->info('Skijasi LMS provider published');
    }

...
class AnnouncementApiTest extends TestCase
{
    ...
    {
        $url = route('skijasi.announcement.add');
    ...
    {
        $url = route('skijasi.announcement.browse');
    ...
    public function testBrowseAnnouncementGivenEnrolledCourseIdExpectResponseCorrectAnnouncements()
    {
        ...
        $url = route('skijasi.announcement.browse', ['course_id' => $course->id]);
        $response = AuthHelper::asUser($this, $user)->json('GET', $url);
    ...
    {
        $url = route('skijasi.announcement.edit', ['id' => 1]);
    ...
    public function testEditAnnouncementGivenNoContentExpectResponse400()
    {
        ...
        $url = route('skijasi.announcement.edit', ['id' => $announcement->id]);
    ...
    {
        $url = route('skijasi.announcement.delete', ['id' => 1]);
    ...
    public function testDeleteAnnouncementGivenUnrelatedAuthorOrTeacherExpectResponse400()
    {
        ...
        $url = route('skijasi.announcement.delete', ['id' => $announcement->id]);
        $response = AuthHelper::asUser($this, $user)->json('DELETE', $url);

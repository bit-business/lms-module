...
namespace NadzorServera\Skijasi\Module\LMS\Tests\Feature;
...
class TopicApiTest extends TestCase
{
    ...
    {
        $url = route('skijasi.topic.browse');
    ...
    public function testBrowseTopicGivenEnrolledCourseIdExpectResponseCorrectTopic()
    {
        ...
        $url = route('skijasi.topic.browse', ['course_id' => $course->id]);
        $response = AuthHelper::asUser($this, $user)->json('GET', $url);
    ...
    {
        $url = route('skijasi.topic.edit', ['id' => 1]);
    ...
    public function testEditTopicGivenNoContent()
    {
        ...
        $url = route('skijasi.topic.edit', ['id' => $topic->id]);
    ...
    {
        $url = route('skijasi.topic.delete', ['id' => 1]);
    ...
    public function testDeleteTopicGivenUserIsNotCreator()
    {
        ...
        $url = route('skijasi.topic.delete', ['id' => $topic->id]);
        $response = AuthHelper::asUser($this, $user)->json('DELETE', $url);

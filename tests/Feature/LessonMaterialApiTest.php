...
class LessonMaterialApiTest extends TestCase
{
    ...
    {
        $url = route('skijasi.lesson_material.add');
    ...
    {
        $url = route('skijasi.lesson_material.read', ['id' => 1]);
    ...
    {
        $url = route('skijasi.lesson_material.edit', ['id' => 1]);
    ...
    public function testEditLessonMaterialGivenUserIsNotCreatorExpectResponse400()
    {
        ...
        $url = route('skijasi.lesson_material.edit', ['id' => $lessonMaterial->id]);
    ...
    {
        $url = route('skijasi.lesson_material.delete', ['id' => 1]);
    ...
    public function testDeleteLessonMaterialGivenUserIsNotCreatorExpectResponse400()
    {
        ...
        $url = route('skijasi.lesson_material.delete', ['id' => $lessonMaterial->id]);
